#!/usr/bin/env python3
"""
Schroders Commercial Refresh v2 — PPTX Generator

15-slide commercial proposal deck matching schroders_commercial_refresh_v2.html.
Google Slides compatible (13.333" × 7.5" widescreen). Backbase brand.

Usage:
    python3 tools/schroders_commercial_v2_pptx.py
"""
...
class SchrodersCommercialV2Pptx:
    ...
    # ── Data ───────────────────────────────────────────────
    YOY_ENT = [
        {'year': 'Year 1', 'phase': 'Foundation', 'lic': 2.29, 'impl': 1.5, 'base': 11.0, 'ai': 0},
        {'year': 'Year 2', 'phase': 'Expand',     'lic': 2.57, 'impl': 1.0, 'base': 17.6, 'ai': 2.0},
        {'year': 'Year 3', 'phase': 'Scale',      'lic': 3.61, 'impl': 0.6, 'base': 27.8, 'ai': 4.0},
        {'year': 'Year 4', 'phase': 'Optimise',   'lic': 4.01, 'impl': 0.6, 'base': 36.8, 'ai': 5.7},
        {'year': 'Year 5', 'phase': 'Compound',   'lic': 4.41, 'impl': 0.6, 'base': 36.1, 'ai': 6.7},
    ]
    YOY_PAG = [
        {'year': 'Year 1', 'phase': 'Foundation', 'lic': 2.72, 'impl': 1.5, 'base': 11.0, 'ai': 0},
        {'year': 'Year 2', 'phase': 'Expand',     'lic': 3.54, 'impl': 1.0, 'base': 17.6, 'ai': 2.0},
        {'year': 'Year 3', 'phase': 'Scale',      'lic': 4.81, 'impl': 0.6, 'base': 27.8, 'ai': 4.0},
        {'year': 'Year 4', 'phase': 'Optimise',   'lic': 4.81, 'impl': 0.6, 'base': 36.8, 'ai': 5.7},
        {'year': 'Year 5', 'phase': 'Compound',   'lic': 4.81, 'impl': 0.6, 'base': 36.1, 'ai': 6.7},
    ]
    ...
    def _slide_02_where_we_stand(self):
        ...
        self._txt(s, 'Five-Year Value (AI from Year 2)', cx, cy + Inches(0.65), cw, Pt(10),
                  size=Pt(8), color=self.SUB_TEXT, align=PP_ALIGN.CENTER)
        self._txt(s, '~7.0×', cx, cy + Inches(0.88), cw, Inches(0.25),
    ...
    def _slide_04_commercial_models(self):
        ...
        self._insight_card(s, 'Key Insight',
            'Enterprise is £0.4M less in Year 1 and £3.7M less over five years. Every price increase maps to a specific module or connector activation. Nothing is arbitrary.',
    ...
    def _slide_05_investment_value(self):
        ...
        self._txt(s, '5-YEAR TOTALS', rcx, chart_top + Inches(0.05), rcw, Pt(10),
                  size=Pt(7), color=self.BLUE, bold=True, align=PP_ALIGN.CENTER)
        self._multi_text(s, [
            ('£21.2M', Pt(22), self.RED, True), ('  ', Pt(10), self.DARK_TEXT, False),
        ...
        self._txt(s, 'Licence £16.9M (Enterprise) + Change £4.3M', rcx, chart_top + Inches(0.67), rcw, Pt(10),
        ...
        self._txt(s, 'Enterprise advantage: Enterprise saves £3.7M over 5 years vs PAG. AI from Day 1. Scaling entry rewards commitment.',
        ...
        pag_rows = [
            ...
            ['Licence', '£2.72M', '£3.54M', '£4.81M', '£4.81M', '£4.81M', '£20.7M'],
        ...
        # PAG stats
        for i, (val, lbl, col) in enumerate([
            ('£25.0M', 'Total Investment', self.RED),
            ('~5.9×', 'ROI', self.BLUE),
            ('Month 9', 'Breakeven', self.AMBER),
        ]):
    ...
    def _slide_06_pricing_bridge(self):
        ...
        rows2 = [
            ...
            ['CLO / Digital Engage', 'Not included', 'Essential MVP → Premium Ph.2', 'Real-time engagement: banners, push, secure messaging.'],
            ...
            ['Marketplace Vendors', 'Mentioned, never priced', 'ComplyAdvantage, Jumio, Twilio, Smarty', 'KYC/AML, identity, comms, address for onboarding.'],
        ]
    ...
    def _slide_13_product_licences(self):
        ...
        self._insight_card(s, 'Key Insight',
            'Every price increase maps to a specific module or connector activation. Nothing is arbitrary. The ramp from £2.3M → £4.4M reflects scope activation, not inflation.',
...
if __name__ == '__main__':
    ...
    out_path = out_dir / 'schroders_commercial_refresh_v2.pptx'

    gen = SchrodersCommercialV2Pptx()
    prs = gen.generate()
